...
export default function PlatformGlance() {
  return (
    <section className="relative overflow-hidden bg-[#faf7ff] py-16 sm:py-24">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-5 lg:px-8">
        ...
        <Reveal className="mt-10 sm:mt-14">
          <div className="grid grid-cols-2 gap-px overflow-hidden rounded-2xl border border-slate-200 bg-slate-200 shadow-md sm:rounded-3xl md:grid-cols-4">
            {GLANCE_STATS.map((s) => (
              <div key={s.label} className="flex flex-col items-center justify-center bg-white p-6 text-center transition-colors hover:bg-fuchsia-50 sm:p-8">
